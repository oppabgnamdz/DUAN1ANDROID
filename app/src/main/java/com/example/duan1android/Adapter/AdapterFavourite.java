...
public class AdapterFavourite extends RecyclerView.Adapter<AdapterFavourite.ViewHolder> {
    ...
    public AdapterFavourite(ArrayList<Story> stories) {
    ...
    public void onBindViewHolder(@NonNull final ViewHolder holder, final int position) {
        ...
        holder.imageStory.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                onClick.callBackClick(stories.get(position).getStoryName(), position);
//                if (result == 1) {
//                    holder.imageStory.setImageResource(R.drawable.yes);
//                } else {
//                    holder.imageStory.setImageResource(R.drawable.favourite);
...
//                }
    ...
    public void OnItemImageClick(OnClick onClick) {
        this.onClick = onClick;
    }

    public interface OnClick {
        void callBackClick(String name, int position);
    }
}
